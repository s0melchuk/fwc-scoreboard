 ...
 * trimming beyond rejecting blank input) since the scoreboard does not attempt to normalise
 * or canonicalise team names against any external reference data.
 */
